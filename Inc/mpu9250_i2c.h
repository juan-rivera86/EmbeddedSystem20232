...
#ifndef MPU9250_I2C_H_
#define MPU9250_I2C_H_
...
#define MPU9250_SLAVE_ADDRESS_0 	0b1101000
#define MPU9250_SLAVE_ADDRESS_1 	0b1101001
...
#define ACCEL_SENSITIVITY 	16384.0f //AFS_SEL=0 LSB/g
#define GYRO_SENSITIVITY 	131.0 //fs_sel=0;
#define TEMP_SENSITIVITY	1.0

#define ACCEL_SENSITIVITY_G	(9.8/ACCEL_SENSITIVITY)
...
//Initialize the Gpio pins for I2C GPIO
void I2C_MpuGpioInit(GPIO_Handle_t *pGPIOHandler);
...
/****
 * 	Communication HAndled with Interrupts
 *
 */
